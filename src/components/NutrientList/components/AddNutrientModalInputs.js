...
function AddNutrientModalInputs(props) {
   ...
   return (
      <React.Fragment>
         <InputText
            className={enteredNutrientNameHasError ? mainStyles.invalid : null}
         ...
         />
         <InputText
            className={enteredUnitHasError ? mainStyles.invalid : null}
            placeholder="Unit"
            value={enteredUnit}
         ...
         />
         <InputText
            className={enteredCaloriesHasError ? mainStyles.invalid : null}
            type={NUMBER}
            min={MIN}
            max={MAX}
         ...
         />
         <InputText
            className={enteredProteinsHasError ? mainStyles.invalid : null}
            type={NUMBER}
            min={MIN}
            max={MAX}
...
export default AddNutrientModalInputs;
